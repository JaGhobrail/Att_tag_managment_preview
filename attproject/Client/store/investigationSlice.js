...
export const fetchQuestions = createAsyncThunk(
  ...
  async () => {
    ...
    url:`http://localhost/api/investigation-summary`, 
    method: 'GET',
    headers: {
...
export const updateQuestion = createAsyncThunk(
  ...
  async ({id,question}) => {
    ...
    const response = await axios(
      {
        url:'http://localhost/api/investigation-summary/'+id, 
        method: 'PUT',
        headers: {
          "Content-Type": "application/json" ,
          "Accept" : "application/json",
...
export const deleteQuestion = createAsyncThunk(
    ...
    async (id) => {
      const response = await axios.delete('http://localhost/api/investigation-summary/'+id);
      return id;
    }
  );
