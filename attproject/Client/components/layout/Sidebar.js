...
const Sidebar = ({ mobileNavsidebar }) => {
    ...
    return (
        <aside className=" w-1/6 py-10 pl-10 bg-gray-900 h-screen overflow-y-scroll min-w-min lg:fixed border-r border-gray-300  hidden md:block ">
            ...
            <div className="mt-12 flex flex-col gap-y-4 text-gray-300 fill-gray-500 text-sm">
                ...
                <Link
                    ...
                    className={
                        router.pathname == "/dashboard"
                            ? "flex items-center space-x-2 py-3  pr-20 border-r-4 border-r-red-600 font-semibold "
                            : "flex items-center space-x-2 py-3  hover:border-r-4 hover:border-r-red-600  hover:font-semibold pr-20"
                    }
                >
                    <svg
                        className={
                ...
                <Link
                    ...
                    className={
                        router.pathname == "/questions"
                            ? "flex items-center space-x-2 py-1 pr-20 border-r-4 border-r-red-600 font-semibold"
                            : "flex items-center space-x-2 py-1 hover:border-r-4 hover:border-r-red-600 hover:font-semibold pr-20"
                    }
                >
                    <svg
                        className={
                ...
                >
                    ...
                    <span>Tracker List</span>
                </Link>

                <Link
                    href="/vendor_list"
                    className={
                        router.pathname == "/vendor_list"
                            ? "flex items-center space-x-2 py-1 pr-20 border-r-4 border-r-red-600 font-semibold"
                            : "flex items-center space-x-2 py-1 hover:border-r-4 hover:border-r-red-600 hover:font-semibold pr-20"
                    }
                >
                ...
                <a
                    ...
                    className=" flex items-center space-x-2 py-1  group hover:border-r-4 hover:border-r-red-600 hover:font-semibold"
                    href="#"
                >
                    <svg
