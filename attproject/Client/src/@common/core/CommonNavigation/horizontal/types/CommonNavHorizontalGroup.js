...
function CommonNavHorizontalGroup(props) {
              ...
              >
                ...
                {nestedLevel > 0 && (
                  <IconButton
                    ...
                    size="large"
                  >
                    <CommonSvgIcon size={16} className="arrow-icon">
                      {theme.direction === 'ltr'
          ...
          <Popper placement={popperPlacement} eventsEnabled={opened} positionFixed>
            {({ ref, style, placement, arrowProps }) =>
              opened && (
                ...
                >
                  <Grow in={opened} id="menu-common-list-grow" style={{ transformOrigin: '0 0 0' }}>
                    <Paper
                      className="rounded-8"
                      onMouseEnter={() => handleToggle(true)}
                      onMouseLeave={() => handleToggle(false)}
...
CommonNavHorizontalGroup.propTypes = {
...
CommonNavHorizontalGroup.defaultProps = {};

const NavHorizontalGroup = withRouter(memo(CommonNavHorizontalGroup));
