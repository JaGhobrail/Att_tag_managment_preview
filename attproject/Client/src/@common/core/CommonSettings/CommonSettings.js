import { useDebounce, usePrevious } from 'src/@common/hooks';
...
function CommonSettings(props) {
  ...
  const themes = useSelector(selectCommonThemesSettings);
    ...
    (_formConfigs, prefix) =>
      Object.entries(_formConfigs).map(([key, formControl]) => {
        ...
        switch (formControl.type) {
          case 'radio': {
            return (
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <FormControl component="fieldset" className="CommonSettings-formControl">
                    ...
                    <RadioGroup
                      ...
                      className="CommonSettings-group"
          ...
          case 'number': {
            return (
              <div key={target} className="CommonSettings-formControl">
                <Controller
                  name={target}
                  control={control}
                  render={({ field }) => (
          ...
          case 'group': {
            return (
              <div key={target} className="CommonSettings-formGroup">
                <Typography className="CommonSettings-formGroupTitle" color="text.secondary">
                  {formControl.title}
                </Typography>
  ...
  return (
    <Root>
      <div className="CommonSettings-formGroup">
        <Typography className="CommonSettings-formGroupTitle" color="text.secondary">
          Layout
        </Typography>
        ...
        <Controller
          ...
          render={({ field }) => (
            <FormControl component="fieldset" className="CommonSettings-formControl">
              ...
              <RadioGroup {...field} aria-label="Layout Style" className="CommonSettings-group">
      ...
      <div className="CommonSettings-formGroup pb-16">
        <Typography className="CommonSettings-formGroupTitle" color="text.secondary">
          Theme
        </Typography>
      ...
      <Controller
        ...
        render={({ field }) => (
          <FormControl component="fieldset" className="CommonSettings-formControl">
            ...
            <RadioGroup {...field} aria-label="Layout Direction" className="CommonSettings-group" row>
...
export default memo(CommonSettings);
