...
const Root = styled('div')(({ theme }) => ({
  '& .CommonSearch-container': {
    position: 'relative',
  },

  '& .CommonSearch-suggestionsContainerOpen': {
    position: 'absolute',
    zIndex: 1,
  ...
  '& .CommonSearch-suggestion': {
    display: 'block',
  },

  '& .CommonSearch-suggestionsList': {
    margin: 0,
    padding: 0,
    listStyleType: 'none',
  },
      ...
      {variant === 'basic' ? (
        ...
        <>
          <TextField
            ...
            InputProps={{
              ...
              classes: {
                input: 'CommonSearch-input py-0 px-16 h-40 md:h-48 ltr:pr-48 rtl:pl-48',
        ...
        <TextField
          ...
          InputProps={{
            ...
            classes: {
              input: 'CommonSearch-input py-0 px-16 h-48 md:h-64',
            },
          }}
          variant="standard"
          {...other}
  ...
  return (
    <MenuItem selected={isHighlighted} component="div">
      <ListItemIcon className="min-w-40">
        {suggestion.icon ? (
          <CommonSvgIcon>{suggestion.icon}</CommonSvgIcon>
        ) : (
        ...
        <div className={clsx('flex items-center w-full', props.className)} ref={popperNode}>
          <Autosuggest
            ...
            theme={{
              ...
              suggestionsList: 'CommonSearch-suggestionsList',
              suggestion: 'CommonSearch-suggestion',
            }}
...
CommonSearch.defaultProps = {
  ...
  trigger: (
    <IconButton className="w-40 h-40" size="large">
      <CommonSvgIcon>heroicons-outline:search</CommonSvgIcon>
    </IconButton>
  ),
  variant: 'full',
  placeholder: 'Search',
...
export default withRouter(memo(CommonSearch));
