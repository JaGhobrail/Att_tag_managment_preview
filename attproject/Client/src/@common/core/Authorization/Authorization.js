...
class Authorization extends Component {
    constructor(props, context) {
        ...
        this.defaultLoginRedirectUrl = props.loginRedirectUrl || '/dashboard';
    }
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        return {
            accessGranted: matched ? CommonUtils.hasPermission(matched.route.auth, userRole) : true,
        };
    }
    ...
    render() {
        // console.info('Common Authorization rendered', this.state.accessGranted);
