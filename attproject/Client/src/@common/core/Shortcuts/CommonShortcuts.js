...
function CommonShortcuts(props) {
      ...
      <Link to={item.url || ''} role="button">
        <MenuItem key={item.id}>
          <ListItemIcon className="min-w-40">
            {item.icon ? (
              <CommonSvgIcon>{item.icon}</CommonSvgIcon>
            ) : (
          ...
          >
                ...
                _item && (
                  <Link to={_item.url} key={_item.id} role="button">
                    ...
                    >
                      ...
                      >
                        {_item.icon ? (
                          <CommonSvgIcon>{_item.icon}</CommonSvgIcon>
                        ) : (
            ...
            >
              <IconButton
                ...
                size="large"
              >
                <CommonSvgIcon sx={{ color: amber[600] }}>heroicons-solid:star</CommonSvgIcon>
              </IconButton>
            </Tooltip>
          </motion.div>
        );
...
CommonShortcuts.propTypes = {};
CommonShortcuts.defaultProps = {
  variant: 'horizontal',
};

export default memo(CommonShortcuts);
