  ...
  return (
    <Paper className="relative flex flex-col flex-auto p-24 pr-12 pb-12 rounded-2xl shadow overflow-hidden">
      ...
      <div className="absolute bottom-0 ltr:right-0 rtl:left-0 w-96 h-96 -m-24">
        {status === 'paid' && (
          <CommonSvgIcon size={96} className="opacity-25 text-green-500 dark:text-green-400">
            heroicons-outline:check-circle
          </CommonSvgIcon>
        )}

        {status === 'pending' && (
          <CommonSvgIcon size={96} className="opacity-25 text-red-500 dark:text-red-400">
