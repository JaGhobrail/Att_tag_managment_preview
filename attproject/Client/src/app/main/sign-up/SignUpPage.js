...
function SignUpPage() {
  ...
  function onSubmit({ displayName, password, email, passwordConfirm }) {
    jwtService
      .createUser({
        name: displayName,
        password,
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-1 min-w-0">
      <img className='hidden sm:flex  w-1/2 h-full overflow-hidden object-none rotate-180' src='/assets/images/bg/shape.svg' />
