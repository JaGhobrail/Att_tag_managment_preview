...
import {
  ...
  navbarOpenFolded,
  selectCommonNavbar,
} from 'app/store/common/navbarSlice';
  ...
  ({ theme, position, folded, foldedandopened, foldedandclosed }) => ({
    ...
    ...(foldedandclosed && {
      '& .NavbarStyle2-content': {
        ...
        '& .common-list-item-text, & .arrow-icon, & .item-badge': {
          opacity: 0,
        },
        '& .common-list-subheader .common-list-subheader-text': {
          opacity: 0,
        },
        '& .common-list-subheader:before': {
          content: '""',
          display: 'block',
          position: 'absolute',
          minWidth: 16,
