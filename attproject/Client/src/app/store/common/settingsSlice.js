...
export const changeCommonTheme = (theme) => (dispatch, getState) => {
...
export const setDefaultSettings = createAsyncThunk(
  'common/settings/setDefaultSettings',
...
const getMainTheme = (state) => state.common.settings.current.theme.main;
const getNavbarTheme = (state) => state.common.settings.current.theme.navbar;
const getToolbarTheme = (state) => state.common.settings.current.theme.toolbar;
const getFooterTheme = (state) => state.common.settings.current.theme.footer;
...
export const selectCurrentSettings = ({ common }) => common.settings.current;

export const selectCommonCurrentLayoutConfig = ({ common }) => common.settings.current.layout.config;

export const selectDefaultSettings = ({ common }) => common.settings.defaults;

export const selectCommonThemesSettings = ({ common }) => common.settings.themes;
