...
class TrackerListRepository implements CrudInterface
{
     ...
     */
    public function create(array $data): TrackerList
    {
    ...
    // : Draft|null
    {
        ...
        return TrackerList::find($id)->note_list;
    }
    ...
    {
        $items = TrackerList::has('drafts')->get();
    ...
    {
        $items = TrackerList::with('drafts')->get();
        foreach ($items as $item) {
            $item->drafts()->delete();
        }
        return $items;
