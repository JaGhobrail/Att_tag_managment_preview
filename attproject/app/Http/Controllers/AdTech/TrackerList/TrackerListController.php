...
namespace App\Http\Controllers\AdTech\TrackerList;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Http\Requests\AdTech\TrackerListRequest;

use App\Repositories\AdTech\TrackerListRepository;
...
class TrackerListController extends Controller
{
    /**
     ...
     *
     * @var TrackerListRepository
     */
    public $tagsRepository;

    public function __construct(TrackerListRepository $tagsRepository)
    {
